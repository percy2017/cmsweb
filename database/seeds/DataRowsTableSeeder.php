...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $productCategorieDataType = DataType::where('slug', 'product_categories')->firstOrFail();
        ...
        // Products Categorias --------------------------------------------------
        // -----------------------------------------------------------
        $dataRow = $this->dataRow($productCategorieDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'number',
                'display_name' => 'Id',
        ...
        $dataRow = $this->dataRow($productCategorieDataType, 'name');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Nombre',
        ...
        $dataRow = $this->dataRow($productCategorieDataType, 'slug');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'hidden',
                'display_name' => 'Slug',
        ...
        $dataRow = $this->dataRow($productCategorieDataType, 'image');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'image',
                'display_name' => 'Imagen Pincipal',
        ...
        $dataRow = $this->dataRow($productCategorieDataType, 'description');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Descripcion',
        ...
        $dataRow = $this->dataRow($productCategorieDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => __('voyager::seeders.data_rows.created_at'),
        ...
        $dataRow = $this->dataRow($productCategorieDataType, 'updated_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => __('voyager::seeders.data_rows.updated_at'),
        ...
        $dataRow = $this->dataRow($productCategorieDataType, 'deleted_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'deletes_at',
                'required'     => 0,
                'browse'       => 0,
                'read'         => 0,
                'edit'         => 0,
        ...
        $dataRow = $this->dataRow($productDataType, 'categorie_id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Nombre',
        ...
        $dataRow = $this->dataRow($productDataType, 'state_id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'select_dropdown',
                'display_name' => 'Estado',
        ...
        // $dataRow = $this->dataRow($productDataType, 'product_belongstomany_products_relationship');
        // if (!$dataRow->exists) {
        //     $dataRow->fill([
        //         'type'         => 'relationship',
        //         'display_name' => 'Roles',
        ...
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'tracking_user',
                'display_name' => 'Trakeando usuario',
                'required'     => 0,
                'browse'       => 0,
                'read'         => 1,
                'edit'         => 1,
        ...
        // FORM Caja --------------------------------------------------
        // -----------------------------------------------------------
        $dataRow = $this->dataRow($CajaDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'number',
                'display_name' => 'Id',
        ...
        $dataRow = $this->dataRow($CajaDataType, 'saldo');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'number',
                'display_name' => 'Saldo',
