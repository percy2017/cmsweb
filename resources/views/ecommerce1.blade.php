          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown ml-3">
              ...
              <a class="nav-link dropdown-toggle waves-effect waves-light dark-grey-text font-weight-bold"
                ...
                <i class="fas fa-cog blue-text"></i> Estilos </a>

              <div class="dropdown-menu dropdown-menu-right dropdown-cyan" aria-labelledby="navbarDropdownMenuLink-4">

                <a class="dropdown-item waves-effect waves-light" href="{{ route('template_change', 'LPS') }}">LP - Software</a>

                <a class="dropdown-item waves-effect waves-light" href="{{ route('template_change', 'LPR') }}">LP - Restorant</a>

                <a class="dropdown-item waves-effect waves-light" href="{{ route('template_change', 'LPH') }}">LP - Hotel</a>
                 <hr />
                 <a class="dropdown-item waves-effect waves-light active" href="{{ route('template_change', 'EC1') }}">EC - Ecommerce v1</a>
                  <hr />
            ...
            <li class="nav-item ml-3">
             ...
             <li class="nav-item ml-3">
              ...
              <a class="nav-link waves-effect waves-light dark-grey-text font-weight-bold" href="/register">

                <i class="fas fa-envelope blue-text"></i> Resgister</a>
...
<div id="myWP"></div>
  ...
  <script type="text/javascript" src="{{ asset('vendor/mdb/ecommerce/js/bootstrap.min.js') }}">
  </script>
  <!-- MDB core JavaScript -->
