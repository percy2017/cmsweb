          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown ml-3">
              ...
              <div class="dropdown-menu dropdown-menu-right dropdown-cyan" aria-labelledby="navbarDropdownMenuLink-4">
                ...
                <a class="dropdown-item waves-effect waves-light" href="{{ route('template_change', 'EC1') }}">Estilo 1</a>

                <a class="dropdown-item waves-effect waves-light" href="{{ route('template_change', 'EC2') }}">Estilo 2</a>

                <a class="dropdown-item waves-effect waves-light" href="{{ route('template_change', 'EC3') }}">Estilo 3</a>
                      ...
                      <div class="row">
                        ...
                        <div class="col-6 pl-0">
                          ...
                          <div class="card-body">
                            ...
                            <!-- Category & Title -->
                            <h5 class="card-title mb-1"><strong><a href="" class="dark-grey-text">iPhone 7</a></strong>
                            </h5>
