          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown ml-3">
              ...
              <div class="dropdown-menu dropdown-menu-right dropdown-cyan" aria-labelledby="navbarDropdownMenuLink-4">
                ...
                <a class="dropdown-item waves-effect waves-light" href="{{ route('template_change', 'EC1') }}">EC - Estilo 1</a>

                <a class="dropdown-item waves-effect waves-light" href="{{ route('template_change', 'EC2') }}">EC - Estilo 2</a>

                <a class="dropdown-item waves-effect waves-light" href="{{ route('template_change', 'EC3') }}">EC - Estilo 3</a>
